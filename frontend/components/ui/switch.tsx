...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ...
    className={cn(
      ...
      'data-[state=checked]:bg-trust-blue data-[state=unchecked]:bg-[var(--border)]',
      className
    )}
    {...props}
  >
    <SwitchPrimitive.Thumb
      className={cn(
        'pointer-events-none block h-4 w-4 rounded-full bg-solid-foreground shadow-lg ring-0 transition-transform',
