...
export default function CaptureModal() {
    ...
    const parseAndAddTerms = useCallback((input: string) => {
        ...
        keyTerms.forEach(t => seen.set(t.toLowerCase(), t))
        newTerms.forEach(t => {
    ...
    const handleSubmit = useCallback(async () => {
        ...
        const projectId = await upload(selectedFile, title || selectedFile.name, keyTerms)
        if (projectId) {
            closeCaptureModal()
            // Library will update via realtime subscription
        }
    }, [selectedFile, title, keyTerms, isUploading, upload, closeCaptureModal])
                ...
                <div className="p-6 overflow-y-auto max-h-[70vh] space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-[10px] text-ink/40 dark:text-white/40 mb-2">
                            MP3, WAV, M4A, AAC, FLAC, MP4, MOV, WebM, OGG (up to 1.5GB)
                        </p>
