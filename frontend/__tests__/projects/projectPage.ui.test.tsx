          ...
          [
            'current',
            {
              ...
              preview: [
                ...
                { id: 's2', transcriptId: 't1', ordinal: 0, customLabel: 'John', paletteIndex: 1 },
                { id: 's3', transcriptId: 't1', ordinal: 0, customLabel: 'Sarah', paletteIndex: 2 },
                { id: 's4', transcriptId: 't1', ordinal: 0, customLabel: 'Mark', paletteIndex: 3 },
              ],
            },
          ],
        ])
