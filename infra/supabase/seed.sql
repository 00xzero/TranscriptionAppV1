...
BEGIN
    ...
    -- ========================================================================
    -- Project 1: Completed transcription
    -- ========================================================================
    INSERT INTO projects (id, user_id, title, status, duration_seconds, source_object_key)
    VALUES (
        project_1_id,
        test_user_id,
        'Sample Interview',
        'completed',
        120,
        test_user_id || '/' || project_1_id || '/interview.mp3'
    ) ON CONFLICT (id) DO NOTHING;

    -- Speakers for Project 1
    INSERT INTO speakers (id, project_id, label, color) VALUES
        (speaker_1_id, project_1_id, 'Interviewer', '#3B82F6'),
        (speaker_2_id, project_1_id, 'Guest', '#10B981')
    ON CONFLICT (id) DO NOTHING;

    -- Segments for Project 1
    ...
    INSERT INTO watchlist (project_id, term, canonical) VALUES
        (project_1_id, 'AI', 'Artificial Intelligence'),
        (project_1_id, 'ML', 'Machine Learning')
    ON CONFLICT DO NOTHING;

    -- ========================================================================
    -- Project 2: Pending upload
    -- ========================================================================
